...
None of this is a discipline problem — it's the predictable result of a convention that only ever lived in one person's head and one prior example. This document makes the convention explicit and gives it a mechanical backstop.
